...
const add_school = async (req, res) => {
    try {
      ...
      console.log(error);
      return res.status(500).json({ message: 'something went wrong in adding a school'});
    }
}
...
const update_school = async (req, res) => {
    try {
        ...
        const { field_name, school_name, degree_title, start_date, end_date, city, description } = req.body;
...
const delete_school = async (req, res) => {
    try {
        ...
        console.log(error);
        return res.status(500).json({ message: 'something went wrong in deleting school'});
    }
}
...
const delete_Education = async (req, res) => {
    try {
        ...
        console.log(error);
        return res.status(500).json({ message: 'something went wrong in deleting education'});
    }
}
