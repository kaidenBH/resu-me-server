...
router.patch('/addSchool/:resumeId', auth, resumeController.resumeFields.education.add_school);
router.patch('/updateSchool/:resumeId/:schoolId', auth, resumeController.resumeFields.education.update_school);
router.delete('/deleteSchool/:resumeId/:schoolId', auth, resumeController.resumeFields.education.delete_school);
router.delete('/deleteEducation/:resumeId', auth, resumeController.resumeFields.education.delete_Education);
